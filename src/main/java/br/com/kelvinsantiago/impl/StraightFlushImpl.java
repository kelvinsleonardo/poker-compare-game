 ...
 */
public class StraightFlushImpl extends AbstractAlgorithmCategory implements IPokerCategory {
    private IPokerCategory nextCategory;

    public StraightFlushImpl(List<Card> cards) {
        super(cards);
    }
    ...
    public int getPoints() {
        return hasStraightFlush() ? PointCategoryHand.STRAIGHT_FLUSH : nextCategory.getPoints();
    }
