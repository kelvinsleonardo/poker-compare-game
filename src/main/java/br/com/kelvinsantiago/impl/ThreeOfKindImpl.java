 ...
 */
public class ThreeOfKindImpl extends AbstractAlgorithmCategory implements IPokerCategory {
    private IPokerCategory nextCategory;

    public ThreeOfKindImpl(List<Card> cards) {
        super(cards);
    }
    ...
    public int getPoints() {
        return hasThreeOfKind() ? PointCategoryHand.THREE_OF_KIND : nextCategory.getPoints();
    }
