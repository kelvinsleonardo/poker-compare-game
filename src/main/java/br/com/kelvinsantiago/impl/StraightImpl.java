...
public class StraightImpl extends AbstractAlgorithmCategory implements IPokerCategory {
    private IPokerCategory nextCategory;

    public StraightImpl(List<Card> cards) {
        super(cards);
    }

    @Override
    public void evaluateNext(IPokerCategory nextRanker) {
        this.nextCategory = nextRanker;
    }

    @Override
    public int getPoints() {
        return hasStraight() ? PointCategoryHand.STRAIGHT : nextCategory.getPoints();
    }
