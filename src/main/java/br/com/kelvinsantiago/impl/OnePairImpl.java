 ...
 */
public class OnePairImpl extends AbstractAlgorithmCategory implements IPokerCategory {

    public OnePairImpl(List<Card> cards) {
        super(cards);
    }

    @Override
    public int getPoints() {
        return hasOnePair() ? PointCategoryHand.ONE_PAIR : PointCategoryHand.HIGH_CARD;
    }
}