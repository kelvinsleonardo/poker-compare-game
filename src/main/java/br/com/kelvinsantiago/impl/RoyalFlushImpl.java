...
public class RoyalFlushImpl extends AbstractAlgorithmCategory implements IPokerCategory {

    private IPokerCategory nextCategory;

    public RoyalFlushImpl(List<Card> cards) {
        super(cards);
    }
    ...
    public int getPoints() {
        return hasRoyalFlush() ? PointCategoryHand.ROYAL_FLUSH : nextCategory.getPoints();
    }
