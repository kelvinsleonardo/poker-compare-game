 ...
 */
public class FourOfKindImpl extends AbstractAlgorithmCategory implements IPokerCategory {
    private IPokerCategory nextCategory;

    public FourOfKindImpl(List<Card> cards) {
        super(cards);
    }
    ...
    public int getPoints() {
        return hasFourOfKind() ? PointCategoryHand.FOUR_OF_KIND : nextCategory.getPoints();
    }
