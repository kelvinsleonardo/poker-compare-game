 ...
 */
public class FullHouseImpl extends AbstractAlgorithmCategory implements IPokerCategory {
    private IPokerCategory nextCategory;

    public FullHouseImpl(List<Card> cards) {
        super(cards);
    }
    ...
    public int getPoints() {
        return hasFullHouse() ? PointCategoryHand.FULL_HOUSE : nextCategory.getPoints();
    }
}
